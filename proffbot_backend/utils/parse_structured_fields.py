...
input_path = "me/structured_profile.json"
output_path = "me/profile_parsed.json"
export_path = "me/parsed_structured_data.json"  # Path for exporting structured data
